...
public class BouncingCreatureTest {
	...
	public void testDirectLeftUp() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(-w/2+1, 0), toRadians(150), 10,  Color.RED);
		creature.move();
	...
	public void testDirectLeftDown() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(-w/2+1, 0), toRadians(210), 10, Color.RED);
		creature.move();
	...
	public void testDirectRightUp() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(w/2-1, 0), toRadians(30), 10, Color.RED);
		creature.move();
	...
	public void testDirectRightDown() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(w/2-1, 0), toRadians(330), 10, Color.RED);
		creature.move();
	...
	public void testDirectUpRight() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(0, -h/2+1), toRadians(30), 10, Color.RED);
		creature.move();
	...
	public void testDirectUpLeft() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(0, -h/2+1), toRadians(150), 10, Color.RED);
		creature.move();
	...
	public void testDirectDownLeft() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(0, h/2-1), toRadians(210), 10, Color.RED);
		creature.move();
	...
	public void testUpperRightCorner45() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(w/2, -h/2), toRadians(45), 1, Color.RED);
		creature.move();
	...
	public void testUpperRightCorner30() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(w/2, -h/2), toRadians(30), 1, Color.RED);
		creature.move();
	...
	public void testDirectBottom() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(0, h/2), toRadians(270), 1, Color.RED);
		creature.move();
	...
	public void testSpecialCorner() throws Exception {
		BouncingCreature creature = new BouncingCreature(environment, new Point2D.Double(w/2, h/2), toRadians(210), 1, Color.RED);
		creature.move();
